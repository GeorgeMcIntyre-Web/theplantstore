...
import { LineChart, Box, ShoppingCart, Users, Upload, Mail } from "lucide-react";
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <aside className="w-56 min-h-screen bg-muted/40 border-r flex flex-col py-8 px-4 gap-2">
        ...
        <nav className="flex flex-col gap-2">
          ...
          <Link href="/admin/categories" className="flex items-center gap-3 px-4 py-3 rounded hover:bg-accent transition text-base font-medium"><Box className="w-5 h-5" /> Categories</Link>

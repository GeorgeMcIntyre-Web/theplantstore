...
const { paystackService } = require('../lib/paystack.ts');
...
Usage: node scripts/paystack-cli.js <command> [options]
...
Examples:
  node scripts/paystack-cli.js test-transaction
  node scripts/paystack-cli.js verify TXN_123456789
  node scripts/paystack-cli.js config

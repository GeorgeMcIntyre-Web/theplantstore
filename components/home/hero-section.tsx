    ...
    <section className="relative min-h-[70vh] flex items-center justify-center text-white overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        >
          ...
          >
            Discover South Africa's finest collection of indoor plants, outdoor
            plants, and succulents delivered nationwide
          </motion.p>
          ...
          >
            ...
            >
              <Link href="/plant-care">Plant Care Guide</Link>
            </Button>
          </motion.div>
        </motion.div>
      </div>

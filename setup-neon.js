...
console.log('🌿 Neon PostgreSQL Setup for The House Plant Store');
console.log('==================================================\n');
...
async function setupEnvironment() {
  ...
  const databaseUrl = await askQuestion('Neon PostgreSQL DATABASE_URL (postgresql://...): ');
...
async function main() {
  log('Starting Neon PostgreSQL setup...', 'blue');
  ...
  log('\n🎉 Neon PostgreSQL setup completed successfully!', 'green');
  log('\nNext steps:', 'blue');
